...
class ApiContractsKarateTest {
    ...
    static void registerProperties(DynamicPropertyRegistry registry) {
        registry.add("client.persona.base-url", WIREMOCK::baseUrl);
    }
                        ...
                        .withBody("""
                                {
                                  ...
                                  "nombre":"Stub Client",
                                  "clienteid":"stub-client",
                                  "contrasena":"secret",
                                  "genero":"M",
                                  "edad":30,
                                  "identificacion":"stub@example.com",
                                  "direccion":"Stub Street 123",
                                  "telefono":"+56999999999",
                                  "estado":"ACTIVO",
                                  "fecha_creacion":"2026-03-08T00:00:00Z"
                                }
                                """)));
    }
}
